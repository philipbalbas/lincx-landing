    ...
    <Container>
          ...
          >
            ...
            <Box mb={[4, 5]}>
              <Text variant="body" mb={3}>
                We empower you to provide alternative solutions for the
                consumers that don't meet your current backend buyer
                requirements. Enhance your customers experience while reclaiming
                lost revenue - effectively reducing your cost per lead in the
                process. Don't leave money on the table.
              </Text>
              <Text variant="body" mb={3}>
              ...
              <Text variant="body">
                ...
                your funnel based on the consumer signals that you provide to
                us.
              </Text>
            </Box>
            <Box>
              <Flex mb={4}>
                ...
                />
                <Text variant="bold">
                  Reclaim opportunities to monetize consumers who didn't meet
                  the criteria set by your back end buyers.
                </Text>
              </Flex>
              ...
              <Flex mb={4}>
                ...
                />
                <Text variant="bold">
                  Lower the cost of acquisition to allow for improved buying
                  power and/or margins.
                </Text>
              </Flex>
            </Box>
          </Box>
          ...
          >
            ...
            <Box mb={5}>
              ...
              <Text variant="body" mb={3}>
                ...
                multi-advertiser listings that complement the consumer
                experience in your sales funnels.
              </Text>
              <Text variant="body">
                ...
                the rank order of either your existing or provided campaigns
                based on the consumer signals that you provide to us.
              </Text>
            </Box>
            <Box>
              <Flex mb={4}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text variant="body">
                  Expand revenue opportunities within your consumer funnel
                  through cross selling and upselling consumers via related
                  offers and service via our extensive buyer networks
                </Text>
              </Box>
              <Box
                sx={{
              ...
              >
                ...
                <Text variant="body">
                  Our proprietary matching technology presents only those
                  advertisers interested in the type of consumer going through
                  your funnel based on the intent signals that you provide to
                  us.
                </Text>
              </Box>
            </Box>
      ...
      >
        ...
        >
          ...
          <Text variant="body">
            Brands cannot ignore their customers for better assistance across
        ...
        >
          ...
          >
            ...
            <Text variant="body">
              It starts with understanding your audience, what problems people
              are solving, what motivates them, and how do you help them find
              the answer.
            </Text>
          </Box>
          <Box
          ...
          >
            ...
            <Text variant="body">
              ...
              individual consumers who in aggregate become highly valued
              audience segments.
            </Text>
          </Box>
          <Box
